...
plot_accuracy_matrix(class_il_matrix, "Online EWC Done Right (Class-IL)", "plots/online_ewc_dr_class_il.png")
plot_accuracy_matrix(task_il_matrix, "Online EWC Done Right (Task-IL)", "plots/online_ewc_dr_task_il.png")
