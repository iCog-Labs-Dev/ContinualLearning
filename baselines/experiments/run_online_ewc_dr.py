...
config = get_config(
    default_method_kwargs=dict(lr=0.001, lr_task1=0.01, batch_size=128, epochs=25, lam=1000, num_samples=200, decay=0.9)
)
...
CLBenchmark(method=method, model=model, tasks=tasks, name="online_ewc_dr").run(params, state)
